...
## Типы поправок на множественное сравнение
...
- средняя доля ложных отклонений гипотез (среди всех отклонений).

Виды:
- Поправка Бенджамини-Хохберга (Benjamini-Hochberg correction)
- Поправка Бенжамини-Екутели (Benjamini-Hochberg-Yekutieli correction)
...
gg_bars_coded <- gg_bars +
  geom_text(aes(y = 30,  label = c("A", "B", "BC", "BC", "C", "C")),
            colour = "black", size = 5)
gg_bars_coded
```
