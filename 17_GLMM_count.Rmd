...
# Краткое введение в GAM и GAMM

---

## Принцип аддитивных моделей

GAM - это аддитивный метод, в котором влияние предикторов отражается с помощью сглаживающих функций (smoother).

Принцип построения сглаживающей функции
...
df <- df %>% mutate(smooth = 1 + 1*x - 1*x^2 + 10*x^3)
