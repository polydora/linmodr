...
- Презентация pdf: [Знакомство с R](01_intro_to_r.pdf)

- Код: [01_intro_to_r_code.R](01_intro_to_r_code.R)

### 01 Знакомство с R (Практикум по основам языка)

Это задание для самостоятельной работы. 

- Задание для практикума: [Знакомство с R](01_intro_to_r_practice.html)
- Данные: [catsM.xlsx](data/catsM.xlsx)
...
```{r eval=FALSE}
install.packages(c("ggplot2", "readxl", "tidyr", "MASS", "car"))

```

<!-- - Презентация: [Основы ggplot2](02_intro_ggplot2.html) -->
...
<!-- - Презентация [03.2_descriptive_statistics_normal_d.html](03.2_descriptive_statistics_normal_d_version_2023.html) -->
<!-- - Объект "population" [population.RData](data/population.RData) -->
...
<!-- - Презентация [04_hypothesis_testing.html](04_hypothesis_testing_version_2023.html) -->
...
<!--     + [05_Correlation_permutation_test.R](05_Correlation_permutation_test.R) -->

<!-- - Данные: -->
<!--     + [IQ_brain.csv](data/IQ_brain.csv) -->
<!--     + [secher.xls](data/secher.xls) -->

### 06 Описание, проверка значимости и валидности линейной модели

<!-- - Презентация: [06_model_description_and_validation.html](07_model_description_and_validation.html) -->

<!-- - Код: -->
<!--     + [06_model_description_and_validation_code.R](07_model_description_and_validation_code.R) -->
<!--     + [06_task_assumptions_catsM.R](07_task_assumptions_catsM.R) -->
<!--     + [06_task_assumptions_GAG.R](07_task_assumptions_GAG.R) -->
<!-- - Данные: -->
<!--     + [IQ_brain.csv](data/IQ_brain.csv) -->
...
### 07 Основы линейной алгебры

<!-- - Презентация: [07_Introduction_to_linear_algebra.html](06_intro_to_linear_algebra.html) -->
<!-- - Код: [07_Introduction_to_linear_algebra_code.R](06_intro_to_linear_algebra_code.R) -->
...
<!-- - Дополнительная презентация "Теоретические основы выбора оптимальной модели": [08.3_model_selection_theory.html](08.3_model_selection_theory.html) -->
...
Часть 1. Модели с разными значениями свобобного члена (intercept) для групп
...
<!-- - Код: [09.1_LM_with_continuous_and_discrete_predictors_code.R](09.1_LM_with_continuous_and_discrete_predictors_code.R) -->
...
Часть 2. Модели с разными значениями углового коэффициента для групп
...
```
<!-- - Презентация: [16_variance_structure.html](16_variance_structure.html) -->
...
<!-- - [Ссылка на видео с хорошим объяснением GAM](https://www.youtube.com/watch?v=sgw4cu8hrZM) -->
