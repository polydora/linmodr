...
Часть 1. Модели с разными значениями свободного члена (intercept) для групп
...
- Код: [09.1_LM_with_continuous_and_discrete_predictors_code_2.R](09.1_LM_with_continuous_and_discrete_predictors_code_2.R)
...
**Для желающих**. Вот очень хороший [**ресурс**](https://lindeloev.github.io/tests-as-linear/), где показано, что большинство классических статистических тестов - это все линейные модели. 
...
- [Очень хороший ресурс для изучения свойств разных распределений](https://www.acsu.buffalo.edu/~adamcunn/probability/probability.html)
...
- Данные:
    ...
    + [Finch_Malaria](data/Finch_Plasmodium.xlsx)
